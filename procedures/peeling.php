...
$title = 'Пилинги лица и тела для решения эстетических проблем';
$description = 'Обновление, омоложение и улучшение качества кожи путем нанесения пилингов с различной кислотностью';
$keywords = 'карбоновый миндальный коралловый пилинг для интимной зоны ботокс эффект пигментация омоложение акне';

require ($_SERVER['DOCUMENT_ROOT'].'/db__access/db__conn.php');

$query = 'SELECT * FROM `peeling`';
...
<main class="container-fluid preview">
    ...
    <div class="row align-items-center ms-0 me-0 px-2 py-5 g-3 text-center">
        <div class="col-lg-6">
            <img src="<? $_SERVER['DOCUMENT_ROOT']?>/images/peeling/<?php echo $result['image']?>" alt="peeling"
