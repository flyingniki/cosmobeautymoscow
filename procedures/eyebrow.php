...
$title = 'Архитектурная коррекция и окрашивание бровей';
$description = 'Аккуратные и красивые брови ваша визитная карточка';
$keywords = 'брови окрашивание коррекция красивые архитектура';

require ($_SERVER['DOCUMENT_ROOT'].'/db__access/db__conn.php');

$query = 'SELECT * FROM `eyebrow`';
...
<main class="container-fluid preview">
    ...
    <div class="row align-items-center ms-0 me-0 px-2 py-5 g-3 text-center">
        <div class="col-lg-6">
            <img src="<? $_SERVER['DOCUMENT_ROOT']?>/images/eyebrow/<?php echo $result['image']?>" alt="eyebrow"
