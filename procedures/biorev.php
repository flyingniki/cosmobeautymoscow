...
$title = 'Биоревитализация лица и тела для омоложения и восстановления кожи';
$description = 'Биоревитализация - инъекционная процедура на основе гиалуроновой кислоты для омоложения кожи';
$keywords ='биоревитализация омоложение молодость увлажнение кожи тела гиалуроновая кислота сокращение морщин';

require ($_SERVER['DOCUMENT_ROOT'].'/db__access/db__conn.php');

$query = 'SELECT * FROM `biorev`';
...
<main class="container-fluid preview">
    ...
    <div class="row align-items-center ms-0 me-0 px-2 py-5 g-3 text-center">
        <div class="col-lg-6">
            <img src="<? $_SERVER['DOCUMENT_ROOT']?>/images/biorev/<?php echo $result['image']?>" alt="biorev"
