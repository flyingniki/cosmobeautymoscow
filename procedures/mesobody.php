...
$title = 'Мезотерапия тела липолитиками для коррекции фигуры';
$description = 'Введение натуральных ферментов тонкими иглами в проблемные зоны для расщепления жира';
$keywords = 'мезотерапия липолитики коррекция фигуры уменьшение объемов тела жира избавление от целлюлита';

require ($_SERVER['DOCUMENT_ROOT'].'/db__access/db__conn.php');

$query = 'SELECT * FROM `mesobody`';
...
<main class="container-fluid preview">
    ...
    <div class="row align-items-center ms-0 me-0 px-2 py-5 g-3 text-center">
        <div class="col-lg-6">
            <img src="<? $_SERVER['DOCUMENT_ROOT']?>/images/mesobody/<?php echo $result['image']?>" alt="mesobody"
