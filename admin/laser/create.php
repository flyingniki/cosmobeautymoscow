...
mysqli_query($connection, "INSERT INTO `laser` (`id`, `title`, `description`, `image`, `contraindications`) VALUES ('$procedure__id', '$procedure__title', '$procedure__description', '$procedure__image', '$procedure__contraindications')");
