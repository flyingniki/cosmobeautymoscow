...
mysqli_query($connection, "UPDATE `facemassage` SET `id` = '$procedure__id', `title` = '$procedure__title', `description` = '$procedure__description', `image` = '$procedure__image', `contraindications` = '$procedure__contraindications' WHERE `facemassage`.`id` = '$id__get'");
