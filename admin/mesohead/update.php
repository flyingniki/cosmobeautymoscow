...
mysqli_query($connection, "UPDATE `mesohead` SET `id` = '$procedure__id', `title` = '$procedure__title', `description` = '$procedure__description', `image` = '$procedure__image', `contraindications` = '$procedure__contraindications' WHERE `mesohead`.`id` = '$id__get'");
