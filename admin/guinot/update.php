...
mysqli_query($connection, "UPDATE `guinot` SET `id` = '$procedure__id', `title` = '$procedure__title', `description` = '$procedure__description', `image` = '$procedure__image', `contraindications` = '$procedure__contraindications' WHERE `guinot`.`id` = '$id__get'");
