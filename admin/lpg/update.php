...
mysqli_query($connection, "UPDATE `lpg` SET `id` = '$procedure__id', `title` = '$procedure__title', `description` = '$procedure__description', `image` = '$procedure__image', `contraindications` = '$procedure__contraindications' WHERE `lpg`.`id` = '$id__get'");
